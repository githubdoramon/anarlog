...
export type NotificationSource = { type: "calendar_event"; event_id: string } | { type: "transcription_complete"; session_id: string } | { type: "mic_detected"; app_names: string[]; app_ids?: string[]; event_ids?: string[] }
